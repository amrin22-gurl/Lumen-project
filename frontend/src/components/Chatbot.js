...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: 'Hello! I\'m your telecom assistant. How can I help you with your subscription today?',
      sender: 'bot',
  ...
  return (
    <ErrorBoundary fallbackMessage="Chat service is temporarily unavailable. Please try refreshing the page.">
      ...
      {/* Chatbot Window */}
      {isOpen && (
        <div className="fixed bottom-20 right-4 w-80 h-96 bg-white border border-gray-300 rounded-lg shadow-xl z-50 flex flex-col">
          {/* Header */}
          <div className="bg-blue-600 text-white p-4 rounded-t-lg flex justify-between items-center">
            <h3 className="font-semibold">Telecom Assistant</h3>
            <button
